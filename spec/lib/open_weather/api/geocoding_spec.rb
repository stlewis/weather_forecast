...
RSpec.describe OpenWeather::Api::Geocoding do
  describe '#by_zip' do
    it 'returns the geocoding data for a given zip code' do
      VCR.use_cassette('geocoding_by_zip') do
        geocoding = OpenWeather::Api::Geocoding.new.by_zip(zip: '90210')
    ...
    context 'with an invalid zip code' do
      it 'returns an error' do
        VCR.use_cassette('geocoding_by_invalid_zip') do
          expect { OpenWeather::Api::Geocoding.new.by_zip(zip: '00000') }
